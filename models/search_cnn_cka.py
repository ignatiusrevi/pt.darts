...
from models.search_cells_cka import SearchCellCKA
...
class SearchCNNCKA(nn.Module):
    ...
    def __init__(self, C_in, C, n_classes, n_layers, n_nodes=4, stem_multiplier=3):
        ...
        for i in range(n_layers):
            ...
            cell = SearchCellCKA(n_nodes, C_pp, C_p, C_cur, reduction_p, reduction)
...
class SearchCNNControllerCKA(nn.Module):
    ...
    def __init__(self, C_in, C, n_classes, n_layers, criterion, n_nodes=4, stem_multiplier=3,
        ...
        self.net = SearchCNNCKA(C_in, C, n_classes, n_layers, n_nodes, stem_multiplier)
